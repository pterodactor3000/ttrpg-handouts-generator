...
- [x] 4.1 Linting passes: `npm run lint` — 2433d5f
- [x] 4.2 Unit tests pass: `npm test -- --project unit` — 2433d5f
- [x] 4.3 Build succeeds: `npm run build` — 2433d5f

#### Manual

- [x] 4.4 Editor shell matches dashboard background — 2433d5f
- [x] 4.5 Picker, chips, inputs, and both dialogs on-palette and legible — 2433d5f
- [x] 4.6 Inputs show a visible palette focus ring — 2433d5f
