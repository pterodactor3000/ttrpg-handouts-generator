...
| 2   | Access-control critical path                          | Prove protected-route gating / authed routing and that a player loads a published-or-archived handout via a valid token              | #1, #2                                               | integration | complete    | `context/archive/2026-06-04-testing-access-control-critical-path/` |
| 3   | Markdown rendering safety                             | Prove malicious markdown is neutralized in both preview and shared output                                                            | #3                                                   | unit        | complete    | `context/archive/2026-06-06-testing-markdown-rendering-safety/` |
